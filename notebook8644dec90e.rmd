...
```
Las tuplas de estos dataset resultan de la observación mensual de precipitaciones en las provincias del territorio español. Se incluyen en los datasets Ceuta, Melilla y las Islas Canarias. Por su parte, las precipitaciones se miden como la precipitación acuosa acumulada media mensualenen en mm. 
...
write_csv(data_base, "/kaggle/working/data_base.csv")
...
#Guardamos nuestro dataset resultante
write_csv(data_2019, "/kaggle/working/data_2019.csv")
...
#Guardamos nuestro dataset resultante
write_csv(data_2020, "/kaggle/working/data_2020.csv")
...
#Guardamos nuestro dataset resultante
write_csv(data_2021, "/kaggle/working/data_2021.csv")
```

Hasta ahora hemos trabajado con formato *wide* en nuestros datasets pero será necesario disponer de los mismos dataset en formato *long*. Por tanto, nuestro tercer paso será convertir estos a formato *long*.

```{r, label = long}
#Convertimos a formato long 2019
...
write_csv(data_2019_long, "/kaggle/working/data_2019_long.csv")

#Convertimos a formato long 2020
...
write_csv(data_2020_long, "/kaggle/working/data_2020_long.csv")

#Convertimos a formato long 2021
...
write_csv(data_2021_long, "/kaggle/working/data_2021_long.csv")
```